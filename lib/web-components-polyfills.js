...
if (useNative) {
  ...
  function created(element) {
    // Each component should fire a DOMComponentLoaded event at this point.
    // if core.js is in scope, we could fireEvent(element, 'DOMComponentLoaded');
    // but I don't know if fireEvent is defined in this scope.
    new CustomEvent('DOMComponentLoaded', {bubbles: true, detail: {element: element}})
